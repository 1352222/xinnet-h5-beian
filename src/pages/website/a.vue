          ...
          <div class="bgtop">
            <div class="weui-cell" style="padding: 0;">
              <div class="weui-cell__bd">
                <div class="weui-uploader upload-bgs clearfix">
                  <!-- <upload-file
                    type="{{compType}}"
                    num="1"
                    id="front"
...
export default {
  ...
  data() {
    return {
      ...
      showErrorInfo: false,
      errorInfo: '',
      height: this.globalData.height * 2 + 100,
      canvasWidth: 375,
      canvasHight: 667,
      loading: false,
      // 状态
...
.top-left-border2 {
  top: 15px;
  left: 50px;
  border-top: 4px #4280f2 solid;
  border-left: 4px #4280f2 solid;
}
.top-right-border2 {
  top: 15px;
  left: 255px;
  border-top: 4px #4280f2 solid;
  border-right: 4px #4280f2 solid;
}
.bottom-left-border2 {
  bottom: 15px;
  left: 50px;
  border-bottom: 4px #4280f2 solid;
  border-left: 4px #4280f2 solid;
}
